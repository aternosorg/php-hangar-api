...
/**
 * VersionStats Class Doc Comment
 *
 * @category Class
 * @package  Aternos\HangarApi
 * @author   OpenAPI Generator team
 ...
 */
class VersionStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VersionStats';
    ...
    */
    ...
    {
        return $this->container['platform_downloads'];
    }

    /**
     * Sets platform_downloads
     *
     * @param array<string,int>|null $platform_downloads platform_downloads
     *
     * @return self
     */
    public function setPlatformDownloads($platform_downloads)
    {
        if (is_null($platform_downloads)) {
