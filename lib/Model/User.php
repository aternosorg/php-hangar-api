...
class User implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets name_history
     *
     * @param \Aternos\HangarApi\Model\UserNameChange[]|null $name_history name_history
     *
     * @return self
     */
    public function setNameHistory($name_history)
    {
        if (is_null($name_history)) {
            throw new \InvalidArgumentException('non-nullable name_history cannot be null');
        }
     ...
     * Sets socials
     *
     * @param mixed|null $socials socials
     *
     * @return self
     */
    ...
    {
        if (is_null($socials)) {
            array_push($this->openAPINullablesSetToNull, 'socials');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('socials', $nullablesSetToNull);
            if ($index !== FALSE) {
