...
/**
 * StringContent Class Doc Comment
 *
 * @category Class
 ...
 */
class StringContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StringContent';
    ...
    */
    ...
    public function setContent($content)
    {
        ...
        if ((mb_strlen($content) < 1)) {
            throw new \InvalidArgumentException('invalid length for $content when calling StringContent., must be bigger than or equal to 1.');
        }
