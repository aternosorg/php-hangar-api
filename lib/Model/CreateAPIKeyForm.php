...
/**
 * CreateAPIKeyForm Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateAPIKeyForm implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAPIKeyForm';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 36)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAPIKeyForm., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($name) < 5)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateAPIKeyForm., must be bigger than or equal to 5.');
        }
     ...
     * Gets permissions
     *
     * @return \Aternos\HangarApi\Model\NamedPermission[]
     */
     ...
     * Sets permissions
     *
     * @param \Aternos\HangarApi\Model\NamedPermission[] $permissions permissions
     *
     * @return self
     */
