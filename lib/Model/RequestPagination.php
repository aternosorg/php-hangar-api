 ...
 */
class RequestPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestPagination';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['limit']) && ($this->container['limit'] > 25)) {
            $invalidProperties[] = "invalid value for 'limit', must be smaller than or equal to 25.";
        }
     ...
     * Sets limit
     *
     * @param int|null $limit The maximum amount of items to return
     *
     * @return self
     */
    public function setLimit($limit)
    {
        ...
        if (($limit > 25)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling RequestPagination., must be smaller than or equal to 25.');
        }
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling RequestPagination., must be bigger than or equal to 1.');
        }
     ...
     * Sets offset
     *
     * @param int|null $offset Where to start searching
     *
     * @return self
     */
    public function setOffset($offset)
    {
        ...
        if (($offset < 0)) {
            throw new \InvalidArgumentException('invalid value for $offset when calling RequestPagination., must be bigger than or equal to 0.');
        }
