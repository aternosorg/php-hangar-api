 ...
 */
class PluginDependency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PluginDependency';
    ...
    */
     ...
     * Sets project_id
     *
     * @param int|null $project_id Project ID of the dependency. Only for non-external dependencies
     *
     * @return self
     */
