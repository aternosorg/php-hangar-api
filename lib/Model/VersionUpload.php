...
class VersionUpload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['channel']) < 1)) {
            $invalidProperties[] = "invalid value for 'channel', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setChannel($channel)
    {
        ...
        if ((mb_strlen($channel) < 1)) {
            throw new \InvalidArgumentException('invalid length for $channel when calling VersionUpload., must be bigger than or equal to 1.');
        }
    ...
    public function setVersion($version)
    {
        ...
        if ((mb_strlen($version) < 1)) {
            throw new \InvalidArgumentException('invalid length for $version when calling VersionUpload., must be bigger than or equal to 1.');
        }
