...
class PermissionsApi
{
     ...
     * @param  string|null $slug Deprecated alias for &#x60;project&#x60; (optional) (deprecated)
     * @param  string|null $organization The id or name of the organization to check permissions in. Must not be used together with &#x60;slug&#x60; (optional)
     * @param  string|null $project The id or slug of the project to check permissions in. Must not be used together with &#x60;organization&#x60; (optional)
     ...
     * @param  \Aternos\HangarApi\Model\NamedPermission[] $permissions The permissions to check (required)
     * @param  string|null $slug Deprecated alias for &#x60;project&#x60; (optional) (deprecated)
     * @param  string|null $organization The id or name of the organization to check permissions in. Must not be used together with &#x60;project&#x60; (optional)
     * @param  string|null $project The id or slug of the project to check permissions in. Must not be used together with &#x60;organization&#x60; (optional)
