...
class ProjectsApi
{
     ...
     *
     * @param  \Aternos\HangarApi\Model\RequestPagination $pagination Pagination information (required)
     * @param  bool|null $prioritize_exact_match Whether to prioritize the project with an exact name match if present (optional, default to true) (deprecated)
     * @param  string|null $sort Used to sort the result (optional)
     ...
     * @param  string|null $member The member of the project (optional)
    ...
    /**
     * Operation projectByVersionHash
     *
     * Returns project of the first version that matches the given file hash (SHA-256)
     *
     * @param  string $hash The SHA-256 hash of the version (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['projectByVersionHash'] to see the possible values for this operation
     *
     * @throws \Aternos\HangarApi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Aternos\HangarApi\Model\Project|\Aternos\HangarApi\Model\Project|\Aternos\HangarApi\Model\Project
     */
    public function projectByVersionHash($hash, string $contentType = self::contentTypes['projectByVersionHash'][0])
    {
        list($response) = $this->projectByVersionHashWithHttpInfo($hash, $contentType);
        return $response;
    }

    /**
     * Operation projectByVersionHashWithHttpInfo
     *
     * Returns project of the first version that matches the given file hash (SHA-256)
     *
     * @param  string $hash The SHA-256 hash of the version (required)
     ...
     * @return array of \Aternos\HangarApi\Model\Project|\Aternos\HangarApi\Model\Project|\Aternos\HangarApi\Model\Project, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectByVersionHashWithHttpInfo($hash, string $contentType = self::contentTypes['projectByVersionHash'][0])
    {
        $request = $this->projectByVersionHashRequest($hash, $contentType);
    ...
    /**
     * Operation projectByVersionHashAsync
     *
     * Returns project of the first version that matches the given file hash (SHA-256)
     *
     * @param  string $hash The SHA-256 hash of the version (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectByVersionHashAsync($hash, string $contentType = self::contentTypes['projectByVersionHash'][0])
    {
        return $this->projectByVersionHashAsyncWithHttpInfo($hash, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation projectByVersionHashAsyncWithHttpInfo
     *
     * Returns project of the first version that matches the given file hash (SHA-256)
     *
     * @param  string $hash The SHA-256 hash of the version (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function projectByVersionHashAsyncWithHttpInfo($hash, string $contentType = self::contentTypes['projectByVersionHash'][0])
    {
        $returnType = '\Aternos\HangarApi\Model\Project';
        $request = $this->projectByVersionHashRequest($hash, $contentType);
    ...
    /**
     * Create request for operation 'projectByVersionHash'
     *
     * @param  string $hash The SHA-256 hash of the version (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['projectByVersionHash'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function projectByVersionHashRequest($hash, string $contentType = self::contentTypes['projectByVersionHash'][0])
    {

        // verify the required parameter 'hash' is set
        if ($hash === null || (is_array($hash) && count($hash) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $hash when calling projectByVersionHash'
            );
        }


        $resourcePath = '/api/v1/versions/hash/{hash}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
